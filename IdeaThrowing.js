...
// Create the scene with background and actors
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Detect if enemies are hit by the bullet and what action to take
        this.physics.add.collider(this.enemies, this.bullets, this.hitEnemy, null, this);

        // Detect if the player is hit
    ...
    shootBullet() {
        // Load in the bullet at the player's location
